            ...
            <div className='flex flex-col justify-between items-center gap-2'>
                ...
                <div className='w-full mt-5'>
                    <div className='flex items-center gap-3 p-2 border-b-2'>
                        ...
                        <div>
                            <h3 className='text-lg font-semibold'>342/14-A</h3>
                    ...
                    <div className='flex items-center gap-3 p-2 border-b-2'>
                        ...
                        <div>
                            <h3 className='text-lg font-semibold'>20km/</h3>
                    ...
                    <div className='flex items-center gap-3 p-2 border-b-2'>
                        ...
                        <div>
                            <h3 className='text-lg font-semibold'>250₹{props.fare[props.vehicleType]}</h3>
