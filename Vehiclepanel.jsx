        ...
        <div>
            ...
            <div onClick={() => {
                ...
                <div className='bg-white w-1/2 p-3'>
                    ...
                    <h5 className='text-sm font-semibold'>30 mins away</h5>
                    <p className='text-xs text-gray-600'>Affordable, compact rides</p>
                </div>
                <h2 className='text-lg font-semibold p-1'>250₹{props.fare.car}</h2>
            </div>
            <div onClick={() => {
                props.setConfirmRidePanel(true)
                ...
                <div className='bg-white w-1/2 p-3'>
                    ...
                    <h5 className='text-sm font-semibold'>45 mins away</h5>
                    <p className='text-xs text-gray-600'>Affordable, auto rides</p>
                </div>
                <h2 className='text-lg font-semibold p-1'>145₹{props.fare.auto}</h2>
            </div>
            <div onClick={() => {
                props.setConfirmRidePanel(true)
                ...
                <div className='bg-white w-1/2 p-3'>
                    ...
                    <h5 className='text-sm font-semibold'>1 hour away</h5>
                    <p className='text-xs text-gray-600'>Affordable, motorcycle rides</p>
                </div>
                <h2 className='text-lg font-semibold p-1'>60₹{props.fare.bike}</h2>
            </div>
        </div>
    )
}
